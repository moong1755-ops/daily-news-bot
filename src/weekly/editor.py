...
후보는 일간에 실제 발송한 기사뿐이다. 외부 기사나 미발송 후보를 추가하지 않는다.
...
- related_reports는 같은 사건의 보도 이력이다. 확정·완료·취소 등 최신 확인된 진전을 반영하고, 과거의 협상이나 확정을 현재 상태처럼 쓰지 않는다. 상충하거나 불명확하면 확정 표현을 피한다.
- 하루의 화제성이나 반복 보도 횟수보다 일주일이 지나도 투자 판단에 남는 변화를 우선한다.
